...
public class MemberController {
    ...
    @PostMapping("/signup")
    public String createNewMember(@Valid MemberSignUpDto memberSignUpDto, BindingResult bindingResult, Model model) {
        // 주석 추가2
        if (bindingResult.hasErrors() || memberService.existMemberCheck(memberSignUpDto)) {
        ...
        Account account = memberService.saveNewMember(memberSignUpDto);
